...
export class PuteventosComponent {
  ...
  enviarDatos(e: any) {
    ...
    if (this.probabilidad && this.impacto) {
      ...
      if (this.calcularIntervaloVerde2(this.valor)) {
        this.nivel_de_riesgo = "Riesgo Aceptable";
      } else if (this.calcularIntervaloAmarrillo2(this.valor)) {
        this.nivel_de_riesgo = "Riesgo Tolerable";
      } else if (this.calcularIntervaloNaranja2(this.valor)) {
        this.nivel_de_riesgo = "Riesgo Alto";
      } else if (this.calcularIntervaloRojo2(this.valor)) {
